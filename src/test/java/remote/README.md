...
3. To start the server: Run `$ java -classpath target/test-classes -Djava.rmi.server.codebase=file:target/test-classes remote.{ServerClass}` Standing in the projects root directory.
