...
public class CodeCacheFull {
    ...
    public final static String eventName = "jdk.CodeCacheFull";
    ...
    public final static longJfrType COMMITED_TOP_ADDRESS = new longJfrType("commitedTopAddress", eventName);
